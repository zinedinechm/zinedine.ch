...
export default function Footer() {
  ...
  return (
    <footer className="mx-auto w-full max-w-[calc(100%-24px)] md:max-w-[609px] mt-[26px] md:mt-[42px] mb-[68px] md:mb-[100px] flex items-center justify-between gap-4 py-0 text-[13px] md:text-sm text-zinc-500">
      <span ref={linesContainerRef} className="leading-normal flex-1 min-w-0">
        <span data-blur-line style={lineBlurStyle} className="pt-[4px] font-medium">
          <a
            href="#"
            onClick={(e) => {
              e.preventDefault();
          ...
          >
            zinedine<span className="text-zinc-400 transition-[color_0.2s_ease] group-hover:text-foreground">.ch</span>
          </a>
        </span>
      </span>
      <svg
        ...
        className="block h-[36px] md:h-[40px] w-auto shrink-0 text-zinc-400"
