...
const baseBtn =
  "inline-flex cursor-pointer items-center justify-center rounded-full px-3 py-[7px] text-sm font-medium transition-colors duration-200 ease-out w-auto shrink-0";
